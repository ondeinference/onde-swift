...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "OndeFramework",
            url: "https://github.com/ondeinference/onde/releases/download/0.1.5/OndeFramework.xcframework.zip",
            checksum: "e914832e2c33a7e816f3972b90319ebf86fa06cf8d0f450fb5f3ae058abb7ff3"
        ),
        .target(
            name: "Onde",
